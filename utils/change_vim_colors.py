...
def update_config_lua(colorscheme, background_type, vim_config_file_loc, begin_marker, end_marker):
...
def update_config_vimscript(colorscheme, background_type, vim_config_file_loc, begin_marker, end_marker):
    chop = re.compile(f"{begin_marker}.*?{end_marker}", re.DOTALL)
...
if __name__ == "__main__":
    ...
    vim_config_file_loc = f'{os.environ["NVIM_DIR"]}/lua/dhth/colors.lua'
    # update_config_vimscript(
    #     colorscheme,
    #     background_type,
    #     vim_config_file_loc,

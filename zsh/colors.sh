...
_dotfiles_apply_colors() {
    ...
    case $theme in
    gruvbox-light-hard)
        export DELTA_FEATURES="gruvbox-light-hard"
        ...
        export LG_CONFIG_FILE="$HOME/.config/lazygit/config.yml,$HOME/.config/lazygit/themes/gruvbox-light-hard.yml"
        ;;
    *)
        export DELTA_FEATURES="gruvbox-dark-hard"
        ...
        export LG_CONFIG_FILE="$HOME/.config/lazygit/config.yml,$HOME/.config/lazygit/themes/gruvbox-dark-hard.yml"
        ;;
    esac
}
